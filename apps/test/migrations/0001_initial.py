# Generated by Django 4.2.13 on 2025-09-16 18:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip', models.URLField(blank=True, null=True, unique=True, verbose_name='آیپی')),
                ('is_active', models.BooleanField(blank=True, choices=[(True, 'فعال'), (False, 'غیر فعال')], default=None, max_length=18, null=True, verbose_name='وضعیت سرور')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='setup.country', verbose_name='کشور')),
