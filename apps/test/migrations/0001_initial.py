# Generated by Django 4.2.13 on 2025-07-28 11:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_state', models.CharField(blank=True, choices=[('True', 'True'), ('False', 'False')], max_length=20, null=True, verbose_name='وضعیت تست')),
                ...
                ('server_test', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='test.servertest', verbose_name='سرور تست')),
