      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output = '<a href="' + baseUrl + 'app/ecommerce/order/details"><span>#' + $order_id + '</span></a>';
            return $row_output;
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<h6 class="m-0"><a href="' + baseUrl + 'pages/profile-user" class="text-body">' +
              $name +
              '</a></h6>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="' + baseUrl + 'app/ecommerce/order/details" class="dropdown-item">مشاهده</a>' +
