        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="' + baseUrl + 'pages/profile-user" class="text-body text-truncate"><span class="fw-medium">' +
              $name +
              '</span></a>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="' + baseUrl + 'app/invoice/preview" data-bs-toggle="tooltip" class="text-body" data-bs-placement="top" title="نمایش فاکتور"><i class="ti ti-eye mx-2 ti-sm"></i></a>' +
              '<div class="dropdown">' +
              ...
              '<a href="' + baseUrl + 'app/invoice/edit" class="dropdown-item">ویرایش</a>' +
